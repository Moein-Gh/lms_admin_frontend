// Sidebar Variant
export const SIDEBAR_VARIANT_OPTIONS = [{ label: "Floating", value: "floating" }] as const;
...
// Sidebar Collapsible
export const SIDEBAR_COLLAPSIBLE_OPTIONS = [{ label: "Icon", value: "icon" }] as const;
...
// Content Layout
export const CONTENT_LAYOUT_OPTIONS = [{ label: "Centered", value: "centered" }] as const;
...
// Navbar Style
export const NAVBAR_STYLE_OPTIONS = [{ label: "Sticky", value: "sticky" }] as const;
