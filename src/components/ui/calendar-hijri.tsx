...
function CalendarPersian({
  ...
  return (
    <DayPicker
      ...
      classNames={{
        root: cn(rootClassName ?? "w-fit", defaultClassNames.root),
...
function CalendarPersianDayButton({ className, day, modifiers, ...props }: React.ComponentProps<typeof DayButton>) {
  const defaultClassNames = getDefaultClassNames();
