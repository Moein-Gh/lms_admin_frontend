...
export const columns: ColumnDef<InstallmentWithRelations>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Link href={`/dashboard/loans/${row.original.loan.id}`} className="font-medium text-primary hover:underline">
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Link href={`/dashboard/users/${row.original.loan.user.id}`} className="font-medium text-primary hover:underline">
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <Link href={`/dashboard/loans/${row.original.loan.id}`} className="text-primary hover:underline">
        مشاهده وام
      </Link>
    )
  }
