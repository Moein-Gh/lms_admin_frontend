...
export default function UserCard({ user }: Props) {
  ...
  const avatarSrc =
    identity.avatarUrl ??
    `https://i5p1o7caz2.ufs.sh/f/x2U4h8rqrclvSEGweo3DWPs8bGcKq1fhNvCwgj4op3rZF0nd`;
    ...
    <div className="w-full card-container flex flex-row flex-wrap md:flex-col">
      ...
      <div className="p-3 md:p-4 relative flex-1 flex flex-row md:flex-col items-center md:items-center gap-3 md:gap-0">
          ...
          <div className="relative inline-block shrink-0">
            ...
            <span
              className={
                ...
                (user.isActive
                  ? "bg-emerald-500 border-white w-5 h-5"
                  : "bg-gray-400 border-white w-5 h-5 opacity-70")
              }
        ...
        <div className="flex flex-col items-start md:items-center flex-1 min-w-0">
          <h3 className="md:mt-3 text-sm md:text-lg font-bold truncate w-full md:w-auto">
            {identity.name}
          </h3>
          <p className="text-xs md:text-sm text-muted-foreground truncate w-full md:w-auto">
            {identity.phone}
          </p>
          ...
          <div className="mt-1.5 md:mt-3 flex flex-col md:flex-row items-start md:items-center gap-1 md:gap-2 w-full md:w-auto">
            ...
            <Separator
              ...
              className="data-[orientation=vertical]:h-4 hidden md:block"
            />
            <Badge className="text-[10px] md:text-xs bg-accent text-accent-foreground whitespace-nowrap">
