...
import { AccountIcon, CircleDollarSign } from "@/components/icons";
      ...
      <Card>
        <CardHeader>
          <div className="w-fit rounded-lg bg-green-500/10 p-2">
            <AccountIcon className="size-5 text-green-500" />
          </div>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          <div className="bg-destructive/10 w-fit rounded-lg p-2">
            <CircleDollarSign className="text-destructive size-5" />
          </div>
        </CardHeader>
        <CardContent className="flex size-full flex-col justify-between">
          <div className="space-y-1.5">
