...
import { type NotificationsStore, createNotificationsStore } from "./notifications-store";

export type NotificationsStoreApi = ReturnType<typeof createNotificationsStore>;

export const NotificationsStoreContext = createContext<NotificationsStoreApi | undefined>(undefined);
